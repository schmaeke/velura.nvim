...
highlights = {
	...
	DiagnosticError = { fg = accents.red0 },
	DiagnosticUnderlineError = { sp = accents.red0, style = "undercurl" },
	DiagnosticWarn = { fg = accents.yellow0 },
	DiagnosticUnderlineWarn = { sp = accents.yellow0, style = "undercurl" },
	DiagnosticInfo = { fg = accents.blue0 },
	DiagnosticUnderlineInfo = { sp = accents.blue0, style = "undercurl" },
